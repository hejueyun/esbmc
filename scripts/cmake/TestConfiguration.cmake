...
function (new_fuzz_test TARGET SRC LIBS)
  ...
  target_compile_options(${TARGET} PRIVATE $<$<C_COMPILER_ID:Clang>:-g -O1 -fsanitize=fuzzer-no-link>)
  target_link_libraries(${TARGET} PRIVATE $<$<C_COMPILER_ID:Clang>:-fsanitize=fuzzer-no-link> ${LIBS} -L=/usr/lib/clang/12/lib/linux/ -lclang_rt.fuzzer_no_main-x86_64)
endfunction()
